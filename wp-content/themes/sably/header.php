				...
				<header id="masthead" class="site-header">
					<div class="header-wrap">
						<div class="nav_logo">
							...
							<?php } elseif ($post->post_name != 'recruiter') { ?>
						...
						<div class="nav_login">
							<?php
							if (is_user_logged_in()) { ?>
								<a <?php if($post->post_name === 'recruiter') { echo 'style="background-color: #1dd1a1;"' ;} ?> class="tabButton button-login" href="<?php echo esc_url(home_url('profile')) ?>"> <i class="fas fa-user" style="color: #fff;"></i> | Mon profil</a>
							<?php } else {
							?>
