    ...
    <div class="wrap-sheet">
        <div id="sheet">
            ...
            foreach ($user_skills as $user_skill) {
                ?>
                <p><?php if(!empty($user_skill->title)) { echo $user_skill->title; } ?></p>
                <p><?php if(!empty($user_skill->subtitle)) { echo $user_skill->subtitle; } ?></p>
                <p><?php if(!empty($user_skill->description)) { echo $user_skill->description; } ?></p>
